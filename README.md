...
| 내 컴퓨터 | 받기 |
| --- | --- |
| **macOS** (M1/M2/M3/M4 등 최근 Mac) | [Vibe Coding Setup 받기 (.dmg)](https://github.com/NewTurn2017/withgenie-vibe-setup/releases/download/v0.1.10/withgenie-setup_0.1.10_darwin_aarch64.dmg) |
| **Windows** 10 / 11 | [Vibe Coding Setup 받기 (.exe)](https://github.com/NewTurn2017/withgenie-vibe-setup/releases/download/v0.1.10/withgenie-setup_0.1.10_windows_x64-setup.exe) |
