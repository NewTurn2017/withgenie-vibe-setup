...
| 내 컴퓨터 | 받기 |
| --- | --- |
| **macOS** (M1/M2/M3/M4 등 최근 Mac) | [위드지니 셋업 받기 (.dmg)](https://github.com/NewTurn2017/withgenie-vibe-setup/releases/download/v0.1.4/withgenie-setup_0.1.4_darwin_aarch64.dmg) |
| **Windows** 10 / 11 | [위드지니 셋업 받기 (.exe)](https://github.com/NewTurn2017/withgenie-vibe-setup/releases/download/v0.1.4/withgenie-setup_0.1.4_windows_x64-setup.exe) |
